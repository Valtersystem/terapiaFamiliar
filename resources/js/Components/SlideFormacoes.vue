...
<template>
  <div class="">
    <Swiper :modules="[Autoplay, Pagination, Navigation,]" :slidesPerView="4" :spaceBetween="6" :navigation="false"
      :loop="true">
      <SwiperSlide class="py-8">
    ...
    <div class="flex items-center justify-center">
      <div class="mt-6 w-86">
        <a class="group flex items-center justify-between gap-4 rounded-2xl border border-indigo-600 bg-indigo-600 px-3 py-2 transition-colors hover:bg-transparent focus:outline-none focus:ring"
          href="#">
          <span
            class="font-medium text-sm text-white transition-colors group-hover:text-indigo-600 group-active:text-indigo-500">
            Mais Formações
          </span>
